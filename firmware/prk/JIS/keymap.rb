...
kbd.add_layer :func, %i[
  ...
  KC_LSFT   XXXXXXX   XXXXXXX   XXXXXXX   XXXXXXX   XXXXXXX   XXXXXXX   XXXXXXX   KC_DEL    KC_END    KC_PGDN   XXXXXXX   XXXXXXX   KC_DEL    KC_INS
  KC_LCTL   KC_LGUI   KC_LALT   XXXXXXX   LNG2_FUNC XXXXXXX   XXXXXXX   XXXXXXX   LNG1_FUNC KC_RALT   KC_RCTL   KC_HOME   KC_PGDN   KC_PGUP   KC_END
]
